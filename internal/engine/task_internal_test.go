...
func TestSetInitialTaskStateAppEngineNoEmulatorDefaults(t *testing.T) {
	...
	setInitialTaskState(&state, time.Now(), "projects/bluebook/locations/us-east1/queues/agentq", "", "")
...
func TestSetInitialTaskStateAppEngineRegionDefaults(t *testing.T) {
	...
	setInitialTaskState(&state, time.Now(), "projects/bluebook/locations/us-east1/queues/agentq", "", "uc")
...
func TestSetInitialTaskStateAppEngineEmulatorHostIgnoresRegion(t *testing.T) {
	...
	setInitialTaskState(&state, time.Now(), "projects/bluebook/locations/us-east1/queues/agentq", "http://localhost:1234", "uc")
...
func TestSetInitialTaskStateAppEngineEmulatorDefaults(t *testing.T) {
	...
	setInitialTaskState(&state, time.Now(), "projects/bluebook/locations/us-east1/queues/agentq", "http://localhost:1234", "")
...
func TestSetInitialTaskStateAppEngineEmulatorTargeted(t *testing.T) {
	...
	setInitialTaskState(&state, time.Now(), "projects/bluebook/locations/us-east1/queues/agentq", "http://nginx", "")
